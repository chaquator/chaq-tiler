...
/*
        ...
        [X] At the end of all windows being created partition by floating, store iterator to first floating window
            globally
        ...
        In the future, there will be an arising issue of whether the tiler will be capable of tracking windows as
        their attributes change and applying new rules accordingly.
